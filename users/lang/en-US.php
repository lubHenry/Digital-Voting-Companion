...
// Signup
$lang = array_merge($lang,array(
	"SIGNUP_TITLE"         =>"Register for new account",
	"SIGNUP_TEXT"					=> "Register",
	"SIGNUP_BUTTONTEXT"		=> "Register Me",
	"SIGNUP_HAVE_ACC"   => "Have account?",
...
$lang = array_merge($lang,array(
	...
	"SIGNIN_TITLE"			=> "Sign into your account",
	"SIGNIN_TEXT"				=> "Log In",
	"SIGNOUT_TEXT"			=> "Log Out",
	"SIGNIN_BUTTONTEXT"	=> "Login",
	"SIGNIN_NO_ACCOUNT" => "Don't have an account?",
	"SIGNIN_REGISTER" => "Register here",
	"SIGNIN_TERMS" => "Terms of use. ",
